...
Route::resource('posts.comments', \App\Http\Controllers\PostCommentController::class)->only('store')->middleware(['auth', 'verified']);
Route::prefix('{post}/likes')->group(function() {
    Route::post('/', [\App\Http\Controllers\PostLikeController::class, 'store'])->name('posts.likes.store');
});
